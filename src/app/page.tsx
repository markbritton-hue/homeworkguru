                ...
                <div className="mt-2 text-center">
                  <div className="relative inline-block">
                    {user.isAnonymous && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10 whitespace-nowrap">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold animate-pulse"
                          style={{ background: "rgba(167,139,250,0.2)", border: "1px solid rgba(167,139,250,0.6)", color: "#c4b5fd", boxShadow: "0 0 12px rgba(167,139,250,0.4)" }}>
                    ...
                    <button
                      ...
                      style={{ background: "rgba(167,139,250,0.15)", border: user.isAnonymous ? "1px solid rgba(167,139,250,0.6)" : "1px solid rgba(167,139,250,0.35)", color: "#c4b5fd", boxShadow: user.isAnonymous ? "0 0 20px rgba(167,139,250,0.35)" : "0 4px 12px rgba(0,0,0,0.2)" }}
                    >
