                ...
                <div className="mt-2 text-center">
                  <div className="relative inline-block">
                    ...
                    <button
                      ...
                      style={{ background: "rgba(167,139,250,0.15)", border: user.isAnonymous ? "1px solid rgba(16,185,129,0.5)" : "1px solid rgba(167,139,250,0.35)", color: "#c4b5fd", boxShadow: user.isAnonymous ? "0 0 20px rgba(16,185,129,0.25)" : "0 4px 12px rgba(0,0,0,0.2)" }}
                    >
